...
Do not add library specific code to fix issues.

Do not modify client applications in sibling directories unless it is to add tmp tests or after confirming with the user, prefer to update our implementation.
